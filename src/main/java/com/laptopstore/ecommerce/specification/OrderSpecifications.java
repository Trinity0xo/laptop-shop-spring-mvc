...
public class OrderSpecifications {
    ...
    public static Specification<Order> emailLike(String email) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.like(root.get("email"),
                "%" + email + "%");
    }
    ...
    public static Specification<Order> orderStatusIn(List<OrderStatusEnum> orderStatus) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.in(root.get("status")).value(orderStatus);
    }
    ...
    public static Specification<Order> dateBetween(Instant startDate, Instant endDate) {
