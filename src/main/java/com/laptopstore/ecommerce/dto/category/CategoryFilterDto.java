...
@Getter
@Setter
public class CategoryFilterDto extends PageableDto {
    ...
    public String toQuery(){
        ...
        String sortField = PaginationUtils.getValidSortBy(Category.class, getSortBy(), Category.DEFAULT_SORT_FIELD);
